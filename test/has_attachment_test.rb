    ...
    context "with styles" do
      ...
      context "when assigned a file" do
        ...
        should "style should have a grid_key for thumb" do
          assert_equal "#{@document.class.to_s.tableize}/#{@document.id}/thumb/#{@document.image.thumb.file_name}", @document.image.thumb.grid_key
        end
        ...
        should "style should have a grid_key for medium" do
          assert_equal "#{@document.class.to_s.tableize}/#{@document.id}/medium/#{@document.image.thumb.file_name}", @document.image.medium.grid_key
        end
